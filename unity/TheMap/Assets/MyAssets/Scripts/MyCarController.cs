...
namespace MyAssets
{
	...
	public class MyCarController : MonoBehaviour
	{
		...
		private Text guiTextCurrentSpeed;
		private Text guiTextMaxSpeed;

		// Use this for initialization
		private void Start ()
		{
			wheelsObject = transform.Find ("Wheels");
			guiTextCurrentSpeed = GameObject.Find ("currentSpeed").GetComponent<Text> ();
			guiTextMaxSpeed = GameObject.Find ("maxSpeed").GetComponent<Text> ();
		...
		private void FixedUpdate ()
		{
			...
			guiTextMaxSpeed.text = (int)(MaxSpeed) + ""; 
			guiTextCurrentSpeed.text = (int)(m_Rigidbody.velocity.magnitude * 3.6f) + "";
